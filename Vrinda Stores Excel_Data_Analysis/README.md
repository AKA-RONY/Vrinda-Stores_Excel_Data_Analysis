...
**ABOUT VRINDA STORES:- <br>**
'VRINDA STORE' is an offline clothing store that performs the online sales operation through various channels(Amazon,flipkart,myntra, etc.)
